...
class SanitizationServiceTest {
    ...
    @Test
    void testSanitize_RemovesScriptTagsWithAttributes() {
    ...
    @Test
    void testSanitize_RemovesOnloadAttribute() {
    ...
    @Test
    void testSanitize_ComplexXSSAttempt() {
    ...
    @Test
    void testSanitize_HandlesWhitespace() {
    ...
    @Test
    void testSanitize_HandlesSpecialCharacters() {
    ...
    @Test
    void testSanitize_HandlesNewlines() {
        String input = "Line 1\nLine 2\rLine 3\r\nLine 4";
        String result = sanitizationService.sanitize(input);
